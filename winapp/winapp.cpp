...
IDirect3DSwapChain9* g_pSwapChain;
bool g_bThreadRun;
HANDLE g_hThreadHandle;
BlockQueue<SurfaceData>	g_frames;
VLCPlayer g_player;
                     ...
                     _In_ int       nCmdShow)
{
    ...
    CreateDevice();
    CreateReaderThread();
    g_player.SetFramePutter(&g_frames);
    g_player.SetURL("rtsp://192.168.4.46/live/chn0");
    //g_player.SetURL("rtsp://192.168.1.229/0");
    g_player.SetDevice(g_pDevice);
