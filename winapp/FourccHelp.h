...
#define VLC_FOURCC(a,b,c,d) MAKEFOURCC(a,b,c,d)
...
{
public:
	static std::string toString(DWORD fmt);
	static int bitsPerPix(DWORD fmt);
	static bool isFourcc(DWORD fmt);
	static int toFFmepgFmt(DWORD fmt);
};
